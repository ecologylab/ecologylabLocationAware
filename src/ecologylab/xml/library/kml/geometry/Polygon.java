 ...
 * 
 */
@simpl_inherit @xml_tag("Polygon") public class Polygon extends ElementState
{
	/**
	...
	@simpl_composite @xml_tag("outerBoundaryIs") OuterBoundaryIs 		obi			= null;
	@simpl_composite @xml_tag("innerBoundaryIs") InnerBoundaryIs 		ibi			= null;
