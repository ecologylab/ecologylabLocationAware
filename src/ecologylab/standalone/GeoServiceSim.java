...
public class GeoServiceSim extends SingletonApplicationEnvironment
{
	...
	private boolean connectGPS()
	{
		try
		{
			gps = new SimGPS(new File(
							"/Users/ztoups-shared/Dropbox/workspaceGit/ecologylabLocationAware/sampleLogs/gps2014-02-13-ZuhlParkingToSH.nmea"),
	...
	public GeoServiceSim(String[] args) throws SIMPLTranslationException, BindException,
	...
	public static void main(String[] args) throws SIMPLTranslationException, BindException,
			ClassCastException, IOException
	{
		GeoServiceSim service = new GeoServiceSim(args);
