...
public class DisplaySignalStrength extends JApplet
{
	...
	public void paint(Graphics g)
	{
		...
		try
		{
			System.out.print("Currently associated MAC: ");
			System.out.println(getAssociatedMac());
		}
		catch (Exception e)
		{
			System.out.println(e);
	...
	public static String getAPData() throws NativeException
	{
		...
		try
		{
			myDll.getFunction("getAPList").call(toReturnArray, ptvalue);
		}
		finally
		{
			myDll.release();
	...
	public static String getAssociatedMac() throws NativeException
	{
		Dll myDll = new Dll("Jwifi");
		...
		try
		{
			myDll.getFunction("getAssociatedMAC").call(toReturnArray, associated);
		}
		finally
		{
			myDll.release();
