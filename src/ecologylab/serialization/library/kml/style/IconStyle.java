...
/**
 * Created according to http://code.google.com/apis/kml/documentation/kml_tags_beta1.html#iconstyle
 * 
 * Specifies how icons for point Placemarks are drawn, both in the Places panel and in the 3D viewer
 * of Google Earth. The <Icon> element specifies the icon image. The <scale> element specifies the
...
public class IconStyle extends ColorStyle
{
	...
	/**
	 * Direction (that is, North, South, East, West), in degrees. Default=0 (North). (See diagram.)
	...
	/**
	 * Constructs a new IconStyle with an icon's URL, an id, the hotspot centered in the icon, the
	 * icon oriented north, and scaled at 1 to 1.
	 * 
	 * @param color
	 * @param colorMode
	 * @param iconURL
	...
	{
		this(id, iconURL, 1.0f, 0f, Icon.CENTERED_HOTSPOT, Color.WHITE, "normal");
	}

	public IconStyle(	String id,
										String iconURL,
										float scale,
										float heading,
										Vec2 hotSpot,
	 ...
	 * 
	 * <Style id="randomColorIcon"> <IconStyle> <color>ff00ff00</color> <colorMode>random</colorMode>
	 * <scale>1.1</scale> <Icon> <href>http://maps.google.com/mapfiles/kml/pal3/icon21.png</href>
